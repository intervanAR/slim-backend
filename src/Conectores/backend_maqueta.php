...
class backend_maqueta implements backend_servicio
{

    /* Métdo invocado cuando se asocia cuentas a usuarios de la OV. Se puede invocar cuando el usuario se registra, en ese caso solo viene el mail (no completó perfil) o cuando busca una cuenta por nro de cuenta


        filtro[nro] - Opcional -  nro de cuenta si se busca una cuenta puntual
        filtro[tipo_cuenta] - Opcional -  tipo de cuenta si se busca una cuenta puntual
        filtro[patente] - Opcional -  Usado para patenes de autos 
        filtro[nro] - Opcional -  es el nro de cuenta si se busca una cuenta puntual
        filtro[tipo_documento] - Opcional -  tipo de documento del perfil de usuario de la OV
        filtro[nro_documento] - Opcional -  nro de documento del perfil de usuario de la OV
        filtro[mail] - Opcional -  mail del perfil de usuario de la OV


        retorna array(
            [tipo_objeto] - Tipo de cuenta
            [id_objeto]  - Nro de cuenta
            )
    ...
    */
    public function get_cuentas($filtro){ 
        ...
        return json_decode('[{"tipo_objeto":"SERV","id_objeto":"2300127500000","alias_cuenta":"Alquiler"}]' , true);
